...
export default function SkillsSection() {
  return (
    <section id="skills" className="scroll-mt-20 py-20 lg:py-32">
      <div className="container">
        <div className="mx-auto mb-12 max-w-3xl text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Teknologi dan tools yang saya gunakan untuk mewujudkan ide menjadi aplikasi.
          </p>
        </div>
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {portfolioData.skills.map((skillCategory) => (
            <Card key={skillCategory.category} className="text-center">
              <CardHeader>
